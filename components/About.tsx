        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <ScrollAnimation delay={100}>
            ...
            <div className="relative w-72 h-72 md:w-96 md:h-96">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-cyan-400 via-teal-500 to-cyan-600 rounded-full" />
              {/* İç resim */}
          ...
          <ScrollAnimation delay={200}>
            ...
            <p className="mb-4 leading-relaxed">
              ...
              Merhaba! Ben Resul, tutkulu bir Full Stack Developer'ım.
              Web teknolojileri ile modern ve kullanıcı dostu uygulamalar
              geliştirmeyi seviyorum.
            </p>

            <p className="mb-6 leading-relaxed">
              Sürekli öğrenmeye ve kendimi geliştirmeye odaklanıyorum.
              Yeni teknolojileri keşfetmek ve projelerimde uygulamak
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-slate-800 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">resul@email.com</p>
              </div>
              <div className="bg-slate-800 p-4 rounded-lg">

    ...
    <footer className="bg-slate-950 text-gray-400 py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          {/* Logo & Açıklama */}
          <div>
            <h3 className="text-2xl font-bold text-cyan-400 mb-4">Resul</h3>
            <p className="text-sm leading-relaxed">
              Modern web teknolojileri ile kullanıcı dostu ve performanslı
              uygulamalar geliştiren Full Stack Developer.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-slate-800 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Resul. Tüm hakları saklıdır.</p>
        </div>
      </div>
    </footer>
  );
